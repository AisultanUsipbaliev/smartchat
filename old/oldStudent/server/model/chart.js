...
// Вставка
	exports.addLesson = async function(group, start, finish) {
		return (await SQL('insert into chart( group_id, start, finish, lesson) values (?, ?, ?, 1)', [group, start, finish])).affectedRows > 0
	}
// Изменение 
