...
function sendConfirmCode(e) 
{
	...
	POST('/account', `method=VERIFY&&code=${code.value}&&phone=${tel.value}`, (res, stat)=>
    {
    	switch(stat)
    	{
...
function sendNewPass(e) 
{
	...
	POST('/account', `method=PASSWORD&&code=${code.value}&&phone=${tel.value}&&password=${firstPass.value}`, (res, stat)=>
		{
