function feedback(name, titles, test, callback)
{
	...
	for(let i = 0; i < titles.length; i++)
		script += `
			<div class="comments">
				<textarea class="comments_area" placeholder="${titles[i]}"></textarea>
...
{
	showPopup(`<div class="thanks">Спасибо за обратную связь!<button class="thxbt" onclick="closePopup()">Хорошо</button></div>	`, {
		width: '90vh',
 		height: '45vh',
 		background: '#fff',
 		close: true
